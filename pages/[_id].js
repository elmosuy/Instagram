...
const Profile = () => {  
 ...
 const {_id}=router.query;
     ...
     const fetching = async()=>{
         const res = await axios.get("http://localhost:4000/homeApp/profile?_id="+_id);
         setpost(res.data) 
  ...
  return (
    <div> <h1>|</h1>
        ...
        <button className='btn-d' onClick={deletepost}>Delete</button> 
       <section className='delete' id='del'>
          <h5>are you sure <b> Delete Post</b></h5>
